...
.controller('MainCtrl', function($scope, Facebook) {
  //set $scope.user and $scope.monitoredPages
...
.controller('nvd3Ctrl', function( $scope ) { 
    ...
    var page_impressions_week = new Array(); 
    var page_impressions_paid = new Array();
    var page_impressions_viral = new Array();  
    var page_impressions_organic = new Array();

    var page_impressions_week_time = new Array();
    var page_impressions_paid_time = new Array();
    var page_impressions_viral_time = new Array(); 
    var page_impressions_organic_time = new Array();
    
    var page_fans_by_like_source = new Array();

    var page_views_time = new Array();

    var page_storytellers_by_story_type = new Array();
    var page_positive_feedback_by_type = new Array();
    var page_story_adds_by_story_type = new Array();
    var page_storytellers = new Array();
    var page_storytellers_time = new Array();

    var value_gender_age = new Array();
    var data_gender_age = new Array();
    var value_language = new Array();
    var data_language = new Array();
    var data_fan_online = new Array();
...
// GEOGRAPHICS : MAP
     FB.api('/'+page_id+'/insights/page_fans_country/lifetime?access_token='+access_token,function (response) {
              ...
              var re = getKeyValueFromJSON(response);
                function getKeyValueFromJSON(response) {
                  var i=1;
                  var keytest = new Array(); 
                  keytest[0] = "Country";
                  var valuetest = new Array();
                  valuetest[0] = "Fans";
...
// FANS : ONLINE ACTIVITY
          FB.api('/'+page_id+'/insights/page_fans_online/day?access_token='+access_token,function (response) {         
                ...
                function getKeyValueFromJSON(response) {
                  var i=0;
                  var keyfans = new Array(); 
                  var valuefans = new Array();
                  var jsonObj = response.data[0].values[0].value;
                  for(var key in jsonObj) {
                    keyfans[i] = key;
...
// PAGE REACH
    ...
    FB.api('/'+page_id+'/insights/page_impressions_organic/day?access_token='+access_token,function (response) {
      ...
      for (var i=0; i<page_impressions_organic.length; i++){
        if (page_impressions_organic[i]== null || page_impressions_organic == NaN){
        ...
        if (true){
              FB.api(
                ...
                for (var i=0; i<page_impressions_paid.length; i++){
                  if (page_impressions_paid[i]== null || page_impressions_paid[i]== NaN){
              ...
              if (true){
                    FB.api(
                        ...
                        for (var i=0; i<page_impressions_viral.length; i++){
                          if (page_impressions_viral[i]== null || page_impressions_viral[i]== NaN){
                    ...
                    if (true){
                          FB.api('/'+page_id+'/insights/page_impressions/week?access_token='+access_token,function (response) {
                              ...
                              for (var i=0; i<page_impressions_week.length; i++){
                                if (page_impressions_week[i]== null || page_impressions_week[i]== NaN){
          ...
          FB.api(
              '/'+page_id+'/insights/page_fans_by_like_source/day?access_token='+access_token,function (response) {
                var count=response.data[0].values[0].value;
                  ...
                  var likesourcesvalues = new Array();
...
// SOURCES : VIEW SOURCES
          ...
          var viewsourcesvalues = new Array();
          ...
          FB.api(
            '/'+page_id+'/insights/page_positive_feedback_by_type/week?access_token='+access_token,function (response) {
                  var count=response.data[0].values[0].value;
                    ...
                    var positivefeedbackvalues = new Array();
          ...
          FB.api(  
              '/'+page_id+'/insights/page_story_adds_by_story_type/week?access_token='+access_token,function (response) {
                    ...
                    var count=response.data[0].values[0].value;
                      ...
                      var talkingaboutvalues = new Array();
      ...
      FB.api(
          ...
          for (var j in response.data[0].values){
              ...
              for (var i=0; i<page_storytellers; i++){
                if (page_storytellers==null || page_storytellers == NaN){
                  page_storytellers = 0;
                }
              }
          ...
          var interactionvalues = new Array();
